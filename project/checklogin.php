...
<body bgcolor="tan">
<center><a href ="#"><img src = "images/logo,jpg" alt="site logo"></a></center><br>     
...
echo "Wrong Username or Password<br><br>Return to <a href=\"user.html\">login</a>";
}
...
<div id="footer"> 
  <div class="bottom_addr">&copy;After voter login page</div>
</div>
</div>
</body>
</html>